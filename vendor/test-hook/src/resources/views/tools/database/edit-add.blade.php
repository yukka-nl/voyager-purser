...
@section('page_header')
    <h1 class="page-title">
        ...
        @else
            {{ 'New Table' }} <div class="Voyager-purser-badge animated bounce" style="display: inline-block; background: #22a7f0; margin-left: 10px; padding: 0px 19px; color: #fff; border-radius: 5px;">Voyager Purser activated</div>
        @endif
    </h1>
@stop
    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div id="dbManager" class="col-md-12">
                <form ref="form" @submit.prevent="stringifyTable" @keydown.enter.prevent action="/admin/database/purser" method="POST">
